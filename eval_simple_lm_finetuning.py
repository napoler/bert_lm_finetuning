    ...
    if args.do_train:
        ...
        for _ in trange(int(1), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                # print(input_ids, input_mask, segment_ids, lm_label_ids, is_next)
                l_next=is_next.tolist()
                outputs = model(input_ids, segment_ids, input_mask, lm_label_ids, is_next)
                pre_next=torch.argmax(outputs[2]).tolist()
                # print( "is_next",l_next[0])
                # print("输出",pre_next)
                if l_next[0]==pre_next:
                    i=i+1
                all=all+1
                if all%100==0:
                    print("acc",i/all)
